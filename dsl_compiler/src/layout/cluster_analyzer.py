...
class ClusterAnalyzer:
    ...
    def _build_adjacency(self, ir_operations: List[IRNode], signal_graph):
        ...
        for op in ir_operations:
            if isinstance(op, (IR_Const, IR_Arith, IR_Decider, IR_MemCreate, IR_MemRead, IR_MemWrite)):
    ...
    def _find_connected_components(self, entities: Set[str], adjacency: Dict[str, Set[str]]) -> List[List[str]]:
    ...
    def _split_if_needed(self, component: List[str], adjacency: Dict[str, Set[str]], base_id: int) -> List[Cluster]:
    ...
    def _recursive_split(self, component: List[str], adjacency: Dict[str, Set[str]], base_id: int, depth: int) -> List[Cluster]:
        """Recursively split component until all parts fit."""
        
        if depth > 10:  # Safety limit
            self.diagnostics.warning("Max split depth reached - creating cluster anyway")
    ...
    def _bisect_component(self, component: List[str], adjacency: Dict[str, Set[str]]) -> Tuple[List[str], List[str]]:
