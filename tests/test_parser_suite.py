...
class TestParserSuite:
    ...
    def test_basic_expressions(self):
        ...
        test_cases = [
            ("int a = 42;", "number literal"),
            ("Signal b = input(0);", "input without type"),
            ('Signal c = input("iron-plate", 1);', "input with type"),
            ("Signal d = a + b;", "binary addition"),
            ("int e = -a;", "unary minus"),
            ("Signal f = a * 2 + b;", "precedence"),
        ]
    ...
    def test_memory_operations(self):
        ...
        test_cases = [
            ...
            ("Signal val = read(counter);", "memory read"),
    ...
    def test_projection_and_bundles(self):
        ...
        test_cases = [
            ('Signal a = input(0) | "iron-plate";', "simple projection"),
            ("Bundle b = bundle(a, b);", "simple bundle"),
            ('Signal c = bundle(a, b) | "steel";', "bundle projection"),
        ]
