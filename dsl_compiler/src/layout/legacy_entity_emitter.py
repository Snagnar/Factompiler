...
from .legacy_signals import EntityPlacement

if TYPE_CHECKING:  # pragma: no cover - type checking aid
    from .legacy_signal_resolver import SignalResolver
...
class EntityEmitter:
    ...
    def __init__(
        self, parent: "LegacyBlueprintEmitter"
    ...
    def _emit_sr_latch_write(self, op: IR_MemWrite) -> None:
        ...
        try:
            ...
            self._record_entity_placement(enable_placement)
            ...
            self._record_entity_placement(injector_placement)
